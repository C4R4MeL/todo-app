    ...
    if (empty($regErrors)) {
        ...
        if (mysqli_stmt_num_rows($stmt) > 0) {
            ...
            if (mysqli_stmt_num_rows($stmt2) > 0) {
                ...
                $stmt3  = mysqli_prepare($conn, "INSERT INTO users (username, email, password) VALUES (?, ?, ?)");
...
<style>
    * {
    ...
    /* ===== BOX UTAMA — flex biasa, tidak ada absolute ===== */
    .auth-box {
        display: flex;
        /* flex biasa */
        width: 100%;
    ...
    /* .auth-box:not(.show-register) {
        height: 520px;
    } */

    /* Info panel lebih lebar saat login */
    .auth-box:not(.show-register) .info-panel {
        width: 50%;
    }

    /* Forms container menyesuaikan sisa ruang */
    .auth-box:not(.show-register) .forms-container {
        width: 50%;
        flex: none;
    }
    ...
    .info-panel {
        ...
        z-index: 10;
        order: 2;
        /* selalu di kanan saat login */
        border-radius: 0 20px 20px 0;
        transition: order 0s,
            border-radius 0.65s cubic-bezier(0.77, 0, 0.175, 1);
    }

    /* Saat register → info panel pindah ke kiri */
    ...
    /* Teks login/register di info panel */
    .info-texts {
        position: relative;
        width: 100%;
        min-height: 110px;
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" class="form-control"
                                placeholder="Masukkan Kata Sandi" id="loginPassword" required>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password"
                                ...
                                placeholder="Masukkan Kata Sandi" id="regPassword"
                        ...
                        <p class="small mb-0 mt-1" id="password-rules-text">
                            Password harus mengandung:
                            <span id="rule-length" class="text-muted">8+ karakter</span>,
                            <span id="rule-upper" class="text-muted">huruf kapital</span>,
                            <span id="rule-lower" class="text-muted">huruf kecil</span>,
                            <span id="rule-number" class="text-muted">angka</span>, dan
                            <span id="rule-special" class="text-muted">karakter spesial</span>.
                        </p>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="confirm_password"
                                ...
                                placeholder="Konfirmasi Kata Sandi" id="confirmPassword"
                                oninput="checkMatch()">
                            <button type="button" class="btn btn-outline-secondary"
...
<script>
    ...
    function checkStrength(val) {
        ...
        for (const [id, ok] of Object.entries(rules)) {
            ...
            // Garis coret kalau sudah terpenuhi, merah kalau belum
